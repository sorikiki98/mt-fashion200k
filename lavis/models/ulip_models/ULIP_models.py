...
## TODO: Convert to lavis_repo format. Currently only supports functionality for XInstructBLIP
...
def ULIP_PointBERT(ulip_v=2):
    ...
    from lavis import PointTransformer
    from lavis import cfg_from_yaml_file
    ## TODO: parse as config
    # config_addr = '/export/home/lavis_repo/lavis/models/ulip_models/pointbert/PointTransformer_8192point.yaml'
