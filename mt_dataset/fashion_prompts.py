...
rollback = [
    "Undo all changes after turn {n_turn} and retrieve the image with {old_attr} replaced by {new_attr}.",
    "Ignore modifications after turn {n_turn} and find the image where {old_attr} is changed to {new_attr}.",
    "Cancel every change following turn {n_turn} and update the image by changing {old_attr} to {new_attr}.",
    "Roll back to before turn {n_turn} and switch {old_attr} to {new_attr} in the image.",
    "Revert everything after turn {n_turn} and retrieve the image with {new_attr} replacing {old_attr}.",
    "Nullify all updates after turn {n_turn} and apply {new_attr} in place of {old_attr}.",
    "Discard all edits made after turn {n_turn} and replace {old_attr} with {new_attr}.",
    "Reset changes post-{n_turn} and modify the image by changing {old_attr} to {new_attr}.",
    "Find the image from just before turn {n_turn} and change {old_attr} to {new_attr}.",
    "Cancel every change past turn {n_turn} and apply {new_attr} instead of {old_attr}.",
    "Ignore all modifications after turn {n_turn} and reflect the replacement of {old_attr} with {new_attr}.",
    "Restore the state before turn {n_turn} and apply {new_attr} over {old_attr}.",
    "Erase all modifications since turn {n_turn} and switch {old_attr} for {new_attr}.",
    "Undo edits from turn {n_turn} onward and find the image with {old_attr} changed to {new_attr}.",
    "Only apply changes up to turn {n_turn} and convert {old_attr} to {new_attr}.",
    "Return to the state before turn {n_turn} and revise {old_attr} to {new_attr}.",
    "Revert any changes after turn {n_turn} and substitute {old_attr} with {new_attr}.",
    "Abandon all changes post-{n_turn} and apply the update {old_attr} to {new_attr}.",
    "Cancel steps after turn {n_turn} and edit the image to reflect {new_attr} in place of {old_attr}.",
    "Stop at turn {n_turn} and find the image with {old_attr} replaced with {new_attr}.",
    "Go back to the image state before turn {n_turn} and apply the change {old_attr} to {new_attr}.",
    "Negate all actions after turn {n_turn} and adjust {old_attr} to {new_attr}.",
    "Reject every change post-{n_turn} and replace {old_attr} with {new_attr}.",
    "Ignore any step after turn {n_turn} and swap {old_attr} with {new_attr}.",
    "Go to the image just before turn {n_turn} and change {old_attr} into {new_attr}.",
    "Only retain changes before turn {n_turn} and apply the change {old_attr} to {new_attr}.",
    "Backtrack to turn {n_turn} and edit the image from there, updating {old_attr} to {new_attr}.",
    "Undo changes from turn {n_turn} forward and make the image reflect {new_attr} instead of {old_attr}.",
    "Rollback all edits after turn {n_turn} and make the change {old_attr} to {new_attr}.",
    "Apply only modifications before turn {n_turn} and transform {old_attr} into {new_attr}.",
    "Erase changes beyond turn {n_turn} and substitute {old_attr} with {new_attr}.",
    "Skip updates after turn {n_turn} and modify the image by switching {old_attr} for {new_attr}.",
    "Ignore everything after turn {n_turn} and update {old_attr} into {new_attr}.",
    "Go back to the version before turn {n_turn} and change {old_attr} to {new_attr}.",
    "Stop at turn {n_turn} and apply the edit from {old_attr} to {new_attr} only.",
    "Reverse all modifications done after turn {n_turn} and apply the new {new_attr} for {old_attr}.",
    "Eliminate all changes post-{n_turn} and find the image with {old_attr} switched to {new_attr}.",
    "Preserve only edits until turn {n_turn} and reflect the change {old_attr} to {new_attr}.",
    "Disregard later steps after turn {n_turn} and make the switch from {old_attr} to {new_attr}.",
    "Remove all transformations after turn {n_turn} and convert {old_attr} to {new_attr}.",
    "Rollback to before turn {n_turn} and replace {old_attr} with {new_attr} in the image.",
    "Limit changes up to turn {n_turn} and implement the update from {old_attr} to {new_attr}.",
    "Reject changes past turn {n_turn} and change {old_attr} into {new_attr}.",
    "Find the pre-{n_turn} version and make the change from {old_attr} to {new_attr}.",
    "Freeze at turn {n_turn} and update the image to reflect {new_attr} instead of {old_attr}.",
    "Go back to just before turn {n_turn} and switch out {old_attr} for {new_attr}.",
    "Revert all past turn {n_turn} and reflect the replacement of {old_attr} by {new_attr}.",
    "Reset the state at turn {n_turn} and update the image by modifying {old_attr} into {new_attr}.",
    "Back up to turn {n_turn} and apply the transformation from {old_attr} to {new_attr}.",
    "Ignore any request made after turn {n_turn} and make {old_attr} into {new_attr}.",
    "Only apply requests until turn {n_turn} and then update {old_attr} to {new_attr} in the image."
]
...
combination = [
    ...
    "Using the most recent result, restore {attr_type1} from before turn {n_turn1} and {attr_type2} from before {n_turn2}, and reflect the transition from {old_attr} to {new_attr}.",
    ...
    "Start from the last retrieved image, bring back {attr_type1} from before turn {n_turn1} and {attr_type2} from before {n_turn2}, and update {old_attr} to {new_attr}.",
    ...
    "Use the current image, roll back {attr_type1} to before turn {n_turn1} and {attr_type2} to before {n_turn2}, then replace {old_attr} with {new_attr}.",
    ...
    "Bring back the state of {attr_type1} before turn {n_turn1} and {attr_type2} before {n_turn2}, then reflect {old_attr} becoming {new_attr}.",
    ...
    "Update the last image by restoring {attr_type1} from before turn {n_turn1} and {attr_type2} from before {n_turn2}, then change {old_attr} to {new_attr}.",
    ...
    "Start from the most recent image, revert both {attr_type1} and {attr_type2} to their states before turns {n_turn1} and {n_turn2}, then reflect {old_attr} to {new_attr}.",
    ...
    "Use the image result, return {attr_type1} and {attr_type2} to how they were before turn {n_turn1} and {n_turn2}, and add the difference from {old_attr} to {new_attr}.",
    ...
    "Roll back {attr_type1} and {attr_type2} to their previous forms at turn {n_turn1} and {n_turn2}, and apply the change from {old_attr} to {new_attr}.",
    ...
    "Start from the current image, reverse {attr_type1} and {attr_type2} to before turn {n_turn1} and {n_turn2}, then replace {old_attr} with {new_attr}.",
    "Take the recent image and reset {attr_type1} and {attr_type2} to their earlier states at turn {n_turn1} and {n_turn2}, and convert {old_attr} to {new_attr}.",
    "Bring back {attr_type1} and {attr_type2} to their values before turn {n_turn1} and {n_turn2}, then update {old_attr} into {new_attr}.",
    ...
    "Undo changes made after turn {n_turn1} to {attr_type1} and turn {n_turn2} to {attr_type2}, and apply {old_attr} to {new_attr}.",
    ...
    "Bring back older settings for {attr_type1} at turn {n_turn1} and {attr_type2} at {n_turn2}, and reflect the change from {old_attr} to {new_attr}.",
    ...
    "Modify the current image to use {attr_type1} from turn {n_turn1} and {attr_type2} from turn {n_turn2}, then apply {old_attr} to {new_attr}.",
    ...
    "Adjust {attr_type1} and {attr_type2} to values before turn {n_turn1} and {n_turn2}, and change {old_attr} into {new_attr}.",
