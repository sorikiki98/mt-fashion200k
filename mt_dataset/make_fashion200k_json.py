...
rollback3 = [t for t in rollback_train if t["n_turns"] == 3]
rollback4 = [t for t in rollback_train if t["n_turns"] == 4]
rollback5 = [t for t in rollback_train if t["n_turns"] == 5]
