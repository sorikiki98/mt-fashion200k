...
combination3 = [t for t in combination_test if t["n_turns"] == 3]
combination4 = [t for t in combination_test if t["n_turns"] == 4]
combination5 = [t for t in combination_test if t["n_turns"] == 5]
